...
const ContactUs = () => {
    return (
        <Container fixed style={{ backgroundColor: 'grey' }}>
            <Grid container spacing={3}>
                ...
                <Grid item xs={6}>
                    ...
                    <p style={{ color: 'white' }}>
                        We invite you to any of our 5 offices for a chat. Feel free to come, we have great coffee and
                        comfy sofas. Looking forward to have you here.
                    </p>
